...
reverb_analysis: python script which performs reverb analysis for reverb identification.
test_correlation: python script to test the correlation method on impulse spaces.
