...
download_files: Audio files downloaded from the Internet Archive database and where user can store his/her files.
...
wet_sounds: Audio files of the sounds stored in samples played in locations around campus, for use with test_correlation.py or reverb_analysis.py tests. 
